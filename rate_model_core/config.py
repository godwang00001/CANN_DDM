...
class DecisionSpaceConfig:
    ...
    dt_DDM: float = 25
    lambda_click_L: float = 0.0
    lambda_click_R: float = 0.0
    delta_click_x: float = 0.05
    x0: float = 0.5
    seed: int | None = None
...
def parse_decision_space_config(decision_space_params):
    return DecisionSpaceConfig(
        ...
        decision_paradigm=decision_space_params.get('decision_paradigm', DecisionSpaceConfig.decision_paradigm),
        ...
        max_time=decision_space_params.get('max_time', DecisionSpaceConfig.max_time),
        boundary=decision_space_params.get('boundary', DecisionSpaceConfig.boundary),
        mar=decision_space_params.get('mar', DecisionSpaceConfig.mar),
        ...
        lambda_click_L=decision_space_params.get('lambda_click_L', DecisionSpaceConfig.lambda_click_L),
        lambda_click_R=decision_space_params.get('lambda_click_R', DecisionSpaceConfig.lambda_click_R),
        delta_click_x=decision_space_params.get('delta_click_x', DecisionSpaceConfig.delta_click_x),
