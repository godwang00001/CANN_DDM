#!/usr/bin/env python3
"""Generate one sweep-level continuous-DDM psychometric dataset with notebook-matching defaults."""
...
def make_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--run-name", default="cddm_psychometric_n200")
...
def main(argv: Sequence[str] | None = None) -> int:
    ...
    print("Continuous DDM psychometric dataset")
